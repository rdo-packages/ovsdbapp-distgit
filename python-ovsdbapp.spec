...
%changelog
* Thu Feb 11 2025 Jakub Libosvar <jakub.libosvar@gmail.com> 2.6.1-2
- Remove dependency on testrepository package

* Wed Jun 05 2024 RDO <dev@lists.rdoproject.org> 2.6.1-1
- Update to 2.6.1

* Thu Mar 14 2024 RDO <dev@lists.rdoproject.org> 2.6.0-1
- Update to 2.6.0
